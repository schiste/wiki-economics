  ...
  return {
    ...
    checks: [
      ...
      },
      {
        ...
        status: "passed",
        evidence: evidenceRef("rollover-safety"),
        baseline_snapshot: "2026-08",
        candidate_snapshot: "2026-09",
        baseline_run_id: "enwiki-rollover-baseline",
        candidate_run_id: "enwiki-rollover-candidate",
        baseline_generation: {
          snapshot: "2026-08",
          complete: true,
          validated: true,
          available_before: true,
          retained_during_rollover: true,
          available_after: true,
          manifest_path: "output/generations/enwiki/2026-08/generation-manifest.json",
        ...
        candidate_generation: {
          ...
          validated: true,
          available_after: true,
          manifest_path: "output/generations/enwiki/2026-09/generation-manifest.json",
          manifest_sha256: digest("f"),
        },
        snapshot_pointer_before: "2026-08",
        snapshot_pointer_after: "2026-09",
        publication_snapshot_before: "2026-08",
        publication_unchanged_during_rollover: true,
        observed_generation_snapshots: ["2026-08", "2026-09"],
        no_mixed_generations: true,
        mixed_snapshot_paths: [],
        cross_generation_references: [],
        cutoff_advanced: true,
        conservation_passed: true,
        previous_generation_available: true,
        storage: {
          capacity_bytes: 2_000_000_000_000,
          required_reserve_bytes: 250_000_000_000,
          persistent_initial_bytes: 700_000_000_000,
          persistent_high_water_bytes: 1_100_000_000_000,
          persistent_final_bytes: 900_000_000_000,
          scratch_high_water_bytes: 180_000_000_000,
          combined_high_water_bytes: 1_280_000_000_000,
          minimum_free_bytes: 720_000_000_000,
          within_budget: true,
        },
      },
      {
